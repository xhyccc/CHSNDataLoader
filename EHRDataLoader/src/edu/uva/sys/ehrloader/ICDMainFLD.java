...
public class ICDMainFLD {
	...
	static {
		try {
			ps = new PrintStream("/Users/bertrandx/Box Sync/CHSN_pattern mining/Jinghe/accuracy-FDA"+t_size+".txt");
...
//		dataRecovery(new PCARecovery(0.1), fm, fm2, missingcodes, sum_miss_codes);
	...
	//	s=new FixedNumberTTSelection(fm,base.getLabels(),5000);
	//	s.select(ss.trainIndex);
	//	FLD=new FLD(s.getTrainingSet(),s.getTrainingLabels());
		sFLD=new PDLassoFLD(s.getTrainingSet(),s.getTrainingLabels());
	//	accuracy("FLD",s.getTestingSet(),s.getTestingLabels(),FLD);
		accuracy("sparseFLD-"+Estimator.lambda,s.getTestingSet(),s.getTestingLabels(),sFLD);
		
	//	ss=new FixedNumberTTSelection(recoveredData,base.getLabels(),5000);
	//	ss.select(s.trainIndex);
	//	FLD=new FLD(ss.getTrainingSet(),ss.getTrainingLabels());
		sFLD=new PDLassoFLD(ss.getTrainingSet(),ss.getTrainingLabels());
	//	accuracy("recoveredFLD",ss.getTestingSet(),ss.getTestingLabels(),FLD);
...
//		sFLD=new PDLassoFLD(s.getTrainingSet(),s.getTrainingLabels());		
//		accuracy("FLD",s.getTestingSet(),s.getTestingLabels(),FLD);
//		accuracy("sparseFLD",s.getTestingSet(),s.getTestingLabels(),sFLD);
//
//		s.select();
//		FLD=new FLD(s.getTrainingSet(),s.getTrainingLabels());
//		sFLD=new PDLassoFLD(s.getTrainingSet(),s.getTrainingLabels());		
...
//		FLD=new FLD(s.getTrainingSet(),s.getTrainingLabels());
//		sFLD=new PDLassoFLD(s.getTrainingSet(),s.getTrainingLabels());		
//		accuracy("recoveredFLD",s.getTestingSet(),s.getTestingLabels(),FLD);
//		accuracy("Daehr",s.getTestingSet(),s.getTestingLabels(),sFLD);
//
//		s.select();
//		FLD=new FLD(s.getTrainingSet(),s.getTrainingLabels());
//		sFLD=new PDLassoFLD(s.getTrainingSet(),s.getTrainingLabels());		
